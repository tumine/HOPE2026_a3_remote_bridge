...
if [[ ! -x "${A3_DEPLOY_PACKAGE_DIR}/a3_body_drive_debug_record" ]]; then
  echo "missing executable: ${A3_DEPLOY_PACKAGE_DIR}/a3_body_drive_debug_record" >&2
...
set +e
"${A3_DEPLOY_PACKAGE_DIR}/a3_body_drive_debug_record" --cfg_file_path "${CFG_FILE}"
RC=$?
set -e
