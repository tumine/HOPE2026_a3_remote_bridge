...
from .joint_order import ISAAC_JOINT_VELOCITY_LIMITS
...
from .station_target import validate_lateral_station_policy_manifest
...
def main(argv: list[str] | None = None) -> int:
    ...
    if cfg.lateral_station.enabled:
        try:
            ...
            print(f"[ref] incompatible policy: {exc}", file=sys.stderr)
            return 2
