...
class HOPEPlannerNode(Node):
    ...
    def __init__(self):
        ...
        # Canonical table-frame strike regions after allowing the trained base
        # target to move laterally from -0.35 m through +0.6625 m.
        ...
        self.declare_parameter("backhand_strike_y_range", [-1.1725, 0.0000])
        ...
        self.declare_parameter("swing_side_split_y", -1.1725)   # touching side boundary
        self.declare_parameter("swing_side_hysteresis_y", 0.0)  # zero keeps coverage continuous
