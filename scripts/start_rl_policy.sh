...
echo "Live new-task TTS window: [${A3_NEW_TASK_TTS_MIN_S:-0.20}, ${A3_NEW_TASK_TTS_MAX_S:-1.00}] s"
echo "Live strike margins: y=+/-${A3_STRIKE_Y_MARGIN_M:-0.08}m z=+/-${A3_STRIKE_Z_MARGIN_M:-0.08}m racket_v=+/-${A3_RACKET_VELOCITY_MARGIN_MPS:-0.15}m/s"
