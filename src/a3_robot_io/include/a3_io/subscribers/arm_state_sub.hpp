...
class ArmStateSub : public SubscriberBase<a3_sync::ArmSample> {
 public:
  static constexpr std::size_t kDof = robot_io::kArmCount;  // 14

  explicit ArmStateSub(
      a3_sync::RingBuffer<a3_sync::ArmSample>& ring,
 ...
 private:
  a3_sync::RingBuffer<a3_sync::ArmSample>& ring_;
};
