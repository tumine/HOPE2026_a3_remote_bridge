...
class LegStateSub : public SubscriberBase<a3_sync::LegSample> {
 public:
  static constexpr std::size_t kDof = robot_io::kLegCount;  // 12

  explicit LegStateSub(
      a3_sync::RingBuffer<a3_sync::LegSample>& ring,
 ...
 private:
  a3_sync::RingBuffer<a3_sync::LegSample>& ring_;
};
