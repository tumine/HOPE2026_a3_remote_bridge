...
bool LegStateSub::ConvertMessage(
...
void LegStateSub::OnMessage(
  ...
  ring_.write([&](a3_sync::LegSample& slot) { slot = sample; });
  MarkReady();
  NotifySample(sample);
}
#endif
