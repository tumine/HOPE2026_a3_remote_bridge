...
function(get_aimrt)
  ...
  if(NOT aimrt_POPULATED)
    ...
    # This state-only bridge transports ROS 2 message types through iceoryx and
    # publishes with rclcpp directly. Protobuf and the extra AimRT plugins are
    # intentionally disabled so an MDU-native build does not require protoc,
    # msgpack or ZeroMQ development packages.
    set(AIMRT_BUILD_WITH_PROTOBUF OFF)
    set(AIMRT_BUILD_WITH_ROS2 ON)
    set(AIMRT_BUILD_ROS2_PLUGIN OFF)
    set(AIMRT_BUILD_ICEORYX_PLUGIN ON)
    set(AIMRT_BUILD_RECORD_PLAYBACK_PLUGIN OFF)
    if(CMAKE_CROSSCOMPILING AND AIMRT_BUILD_WITH_PROTOBUF)
