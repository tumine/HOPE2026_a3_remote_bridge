...
the x target stays at startup while y is derived from the planner's hit point and
...
def build_observation(
    ...
    obs[o:o + 2] = np.asarray(base_target_xy)[:2] - base_pos[:2]; o += 2      # moving station error
