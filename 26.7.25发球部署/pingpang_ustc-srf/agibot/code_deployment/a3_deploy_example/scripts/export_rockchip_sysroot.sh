...
Options:
  ...
  --output PATH    Output tarball.
                   Default: a3_deploy_example/thirdparty/rockchip_sysroot/rockchip-1.0-aarch64-sysroot.tar.gz
  -h, --help       Show this help message.

The script creates a container from the arm64 Rockchip image and exports the
target sysroot pieces needed by Dockerfile.a3-rockchip-builder. It does not
execute inside the arm64 container, so qemu is not required.
USAGE
}
