...
bool ArmStateSub::ConvertMessage(
...
void ArmStateSub::OnMessage(
  ...
  ring_.write([&](a3_sync::ArmSample& slot) { slot = sample; });
  MarkReady();
  NotifySample(sample);
}
#endif
