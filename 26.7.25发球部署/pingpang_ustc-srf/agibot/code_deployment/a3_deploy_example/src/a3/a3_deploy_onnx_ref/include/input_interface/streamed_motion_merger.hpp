...
public:
    ...
    void Reset() {
        ...
        streamed_motion_->ReserveCapacity(1, 29, 1, 1, 0, 0);
    ...
    MergeResult MergeIncomingData(const IncomingData& data, int current_playback_frame) {
        ...
        auto new_motion = CreateNewMotion(data, merge_dst_frame + data.num_frames);
...
private:
    ...
    std::shared_ptr<MotionSequence> CreateNewMotion(const IncomingData& data,
