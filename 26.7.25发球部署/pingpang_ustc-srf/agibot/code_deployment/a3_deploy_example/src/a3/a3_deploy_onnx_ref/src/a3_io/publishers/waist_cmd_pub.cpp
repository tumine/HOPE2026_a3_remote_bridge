...
void WaistCmdPub::BuildMessage(const robot_io::RobotCommand& cmd_31,
                               std::int64_t stamp_ns, std::uint32_t seq,
                               joint_msgs::msg::JointCommand& out) {
  FillJointCommandMsg<kDof>(cmd_31, robot_io::kA3WaistStart,
                            robot_io::kA3WaistJointNames, stamp_ns, seq, out);
}

void WaistCmdPub::Publish(std::int64_t stamp_ns, std::uint32_t seq,
