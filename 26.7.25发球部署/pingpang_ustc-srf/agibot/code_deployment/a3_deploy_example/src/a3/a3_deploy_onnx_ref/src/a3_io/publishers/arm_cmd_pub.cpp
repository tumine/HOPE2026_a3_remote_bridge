...
void ArmCmdPub::BuildMessage(const robot_io::RobotCommand& cmd_31,
                             std::int64_t stamp_ns, std::uint32_t seq,
                             joint_msgs::msg::JointCommand& out) {
  FillJointCommandMsg<kDof>(cmd_31, robot_io::kA3ArmStart,
                            robot_io::kA3ArmJointNames, stamp_ns, seq, out);
}

void ArmCmdPub::Publish(std::int64_t stamp_ns, std::uint32_t seq,
