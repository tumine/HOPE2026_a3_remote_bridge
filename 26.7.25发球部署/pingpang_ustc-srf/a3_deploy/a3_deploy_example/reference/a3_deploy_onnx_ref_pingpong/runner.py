...
class PingPongReferenceRunner:
    ...
    def run(self, max_ticks: int | None = None, realtime: bool = False,
        ...
        # Training samples the first target from the fixed station. Preserve its
        # world position so target-minus-base changes when the robot drifts.
        self.lifecycle.lock_ready_reference(state.base_pos_w)
