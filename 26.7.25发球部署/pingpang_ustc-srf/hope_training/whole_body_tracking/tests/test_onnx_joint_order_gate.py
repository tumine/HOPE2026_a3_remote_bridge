...
The exporter hard-gates the name-based simulator mapping against the canonical joint order
and embeds the canonical order in the ONNX metadata; ``OnnxPolicy`` re-validates it at load
